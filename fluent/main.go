// Contact Manager - a Fluent example application demonstrating
// server-rendered HTML with plain HTTP, built with reusable
// components and the chain router. Run it and visit
...
import (
	...
	"github.com/jpl-au/fluent-examples/fluent/server"
)
...
func main() {
	...
	go func() {
		slog.Info("fluent contact manager listening on http://localhost:8080")
