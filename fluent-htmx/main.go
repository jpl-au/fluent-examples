// Contact Manager - a Fluent-HTMX example application demonstrating
// server-rendered HTML with HTMX partial page updates, built with
...
import (
	...
	"github.com/jpl-au/fluent-examples/fluent-htmx/server"
)
...
func main() {
	...
	go func() {
		slog.Info("fluent-htmx contact manager listening on http://localhost:8080")
